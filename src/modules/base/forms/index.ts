...
export const FormModule: ModuleDefinition<FormProps> = {
  ...
  keywords: ['contact form', 'fields', 'signup', 'submit', 'subscribe'],
  category: 'Forms',
  version: '1.0.0',
...
export const LabelModule: ModuleDefinition<LabelProps> = {
  ...
  keywords: ['field label', 'caption', 'form label', 'legend'],
  category: 'Forms',
  version: '1.0.0',
  icon: TextStartTIcon,
  trusted: true,
...
export const InputModule: ModuleDefinition<InputProps> = {
  ...
  keywords: ['field', 'text field', 'form field', 'entry', 'type'],
  category: 'Forms',
  version: '1.0.0',
  icon: TextStartTIcon,
  trusted: true,
...
export const TextareaModule: ModuleDefinition<TextareaProps> = {
  ...
  keywords: ['multiline', 'message', 'long text', 'comment', 'notes'],
  category: 'Forms',
  version: '1.0.0',
  icon: TextStartTIcon,
  trusted: true,
...
export const SelectModule: ModuleDefinition<SelectProps> = {
  id: 'base.select',
  name: 'Select',
  description: 'A select menu the reader picks one option from.',
  keywords: ['dropdown', 'picker', 'menu', 'choose', 'combo'],
  category: 'Forms',
  version: '1.0.0',
...
export const OptionModule: ModuleDefinition<OptionProps> = {
  ...
  keywords: ['choice', 'dropdown item', 'menu item', 'value'],
  category: 'Forms',
  version: '1.0.0',
  icon: CheckboxSolidIcon,
  trusted: true,
...
export const OptionGroupModule: ModuleDefinition<OptionGroupProps> = {
  ...
  keywords: ['optgroup', 'grouped options', 'section', 'category'],
  category: 'Forms',
  version: '1.0.0',
  icon: CheckboxSolidIcon,
  trusted: true,
...
export const SubmitModule: ModuleDefinition<SubmitProps> = {
  ...
  keywords: ['send', 'form button', 'cta', 'confirm'],
  category: 'Forms',
  version: '1.0.0',
  icon: SendSolidIcon,
  trusted: true,
...
export const FormMessageModule: ModuleDefinition<FormMessageProps> = {
  ...
  keywords: ['error', 'success', 'validation', 'status', 'feedback'],
  category: 'Forms',
  version: '1.0.0',
...
function choiceModule(args: {
  ...
  return {
    ...
    keywords: ['choice', 'option', 'select', 'tick'],
    category: 'Forms',
    version: '1.0.0',
    icon: CheckboxSolidIcon,
    trusted: true,
