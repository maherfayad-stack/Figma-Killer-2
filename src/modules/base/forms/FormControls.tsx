...
export function FormEditor({ children, mcClassName, nodeWrapperProps, props }: ModuleComponentProps<FormProps>) {
  ...
  return (
    <form
      ...
      data-studio-form-editor-preview={previewState !== 'default' ? previewState : undefined}
      data-studio-form-state={runtimeState !== 'default' ? runtimeState : undefined}
...
export function FormMessageEditor({ mcClassName, nodeWrapperProps, props }: ModuleComponentProps<FormMessageProps>) {
  ...
  return (
    <div
      {...nodeWrapperProps}
      className={mcClassName}
      data-studio-form-message={props.kind}
      data-studio-form-id={normalizeIdentifierValue(props.formId)}
      data-studio-form-preview-active={previewActive ? 'true' : undefined}
