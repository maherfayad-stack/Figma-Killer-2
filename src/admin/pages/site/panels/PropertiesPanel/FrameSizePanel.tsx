...
import { NumberControl } from '@site/property-controls/NumberControl'
    ...
    <div className={styles.panel} data-testid="frame-size-panel">
      ...
      <div className={styles.dimensions}>
        <NumberControl
          ...
          value={width}
          min={MIN_FRAME_SIZE}
          onChange={(_key, value) => setFrameSize(frame.pageId, value, height)}
        />
        <NumberControl
          propKey="frameHeight"
          label="H"
          value={height}
          min={MIN_FRAME_SIZE}
          onChange={(_key, value) => setFrameSize(frame.pageId, width, value)}
        />
      </div>
    </div>
  )
