 ...
 * workspace concepts from before Studio became the only editor mode, and the
 * panels that served them have been deleted), so this component only ever
 * mounts `StudioBoardsList` + `StudioPagesTree`.
 */
