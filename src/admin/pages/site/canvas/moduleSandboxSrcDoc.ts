...
export const SANDBOX_MESSAGE_SOURCE = 'studio-module-sandbox'
export const HOST_MESSAGE_SOURCE = 'studio-module-host'
...
<html lang="en">
  <head>
    ...
    <style id="studio-class-styles">${escapeStyleContent(classCSS)}</style>
  </head>
  <body>
    <div id="root"></div>
    <script type="module">
      ...
      const classStyleEl = document.getElementById('studio-class-styles');
      ...
      function showError(error) {
        ...
        pre.className = 'studio-runtime-error';
