...
/**
 * The one definition of this namespace's base path. Exported because
 * `gitSyncRequests.ts` — the remote half of the same surface, split out when
 * this file outgrew its line budget — must not carry a second copy of it.
 */
export const GIT_API_BASE = '/admin/api/studio/git'

const BASE = GIT_API_BASE
