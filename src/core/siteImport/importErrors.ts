 ...
 *
 * Thrown by `ingestInput`'s input guards (empty input, oversize, zip-bomb,
 * too-many-files, path-traversal) so callers can distinguish failure reasons
 * with `instanceof` checks instead of parsing error messages.
 *
