...
describe('CanvasModulePlaceholder', () => {
  ...
  it('keeps block placeholder content stack rules in module and iframe chrome CSS', () => {
    ...
    expect(chromeInjector).toContain('[data-studio-placeholder-content]')
    ...
    expect(chromeInjector).toContain('[data-studio-placeholder-icon] > svg')
  ...
  it('renders the empty image placeholder as a compact centered row', () => {
    ...
    const root = container.querySelector('[data-canvas-module-placeholder]')
    const icon = container.querySelector('[data-studio-placeholder-icon]')
  ...
  it('keeps empty-state icon and label inside an isolated content stack', () => {
    ...
    const root = container.querySelector('[data-canvas-module-placeholder]')
    const content = root?.querySelector('[data-studio-placeholder-content]')
    expect(content).not.toBeNull()
    expect(content?.querySelector('[data-studio-placeholder-icon]')).not.toBeNull()
    expect(content?.querySelector('[data-studio-placeholder-label]')?.textContent).toBe('No image selected')
  })
})
