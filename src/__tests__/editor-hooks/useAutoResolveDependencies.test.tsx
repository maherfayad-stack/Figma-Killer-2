...
const CONFETTI_IMPORTMAP = {
  lockHash: 'test-lock',
  imports: {
    'canvas-confetti': '/_studio/runtime/cache/test-lock/canvas-confetti/dist/confetti.module.mjs',
    'canvas-confetti/': '/_studio/runtime/cache/test-lock/canvas-confetti/',
  },
}
  ...
  it('is a no-op when the lock is already in-sync', async () => {
    ...
    const runtime = normalizeSiteRuntimeConfig({
      ...
      packageImportmap: {
        ...
        imports: {
          'canvas-confetti': '/_studio/runtime/cache/in-sync-hash/canvas-confetti/dist/confetti.module.mjs',
          'canvas-confetti/': '/_studio/runtime/cache/in-sync-hash/canvas-confetti/',
        },
      },
    })
    useEditorStore.setState({
    ...
    globalThis.fetch = (async () => {
      ...
      return new Response(JSON.stringify({
        ...
        packageImportmap: {
          ...
          imports: {
            'canvas-confetti': '/_studio/runtime/cache/test-lock-burst/canvas-confetti/dist/confetti.module.mjs',
            'canvas-confetti/': '/_studio/runtime/cache/test-lock-burst/canvas-confetti/',
            three: '/_studio/runtime/cache/test-lock-burst/three/build/three.module.js',
            'three/': '/_studio/runtime/cache/test-lock-burst/three/',
            motion: '/_studio/runtime/cache/test-lock-burst/motion/dist/index.mjs',
            'motion/': '/_studio/runtime/cache/test-lock-burst/motion/',
          },
        },
      }), { status: 200 })
    }) as typeof fetch
