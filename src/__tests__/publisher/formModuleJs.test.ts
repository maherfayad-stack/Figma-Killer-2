...
describe('base.form module-JS emission', () => {
  it('emits the form runtime as js when mode is cms', () => {
    ...
    expect(out.html).toContain('data-studio-form-mode="cms"')
  })
  ...
  it('runtime binds via document-level delegation and reads pageId per form', () => {
    ...
    expect(FORM_RUNTIME_JS).toContain('data-studio-page-id')
    expect(FORM_RUNTIME_JS).toContain('/_studio/form/challenge')
    expect(FORM_RUNTIME_JS).toContain('/_studio/form/submit')
  })
})
