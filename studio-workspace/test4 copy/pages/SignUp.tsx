          ...
          <div className={styles.fields}>
            <div className={styles.phoneRow}>
              ...
              <div className={styles.numberField}>
                <TextInput label={t.signUp.mobileNumber} value={mobileNumber} onChange={(e) => setMobileNumber(e.target.value)} required disabled={false} errorText="" skeleton={false} password={false} multiline={false} dropdown={false} />
              </div>
            </div>
