...
import { Button, BottomActionBar } from '@alm-design/design-system'
...
export default function Onboarding() {
  ...
  return (
    <main className={styles.page}>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.footer}>
          <div className={styles.cta} style={{ width: "360px" }}>
            <Button variant="primary" size="medium" label={t.onboarding.agree} className={styles.ctaButton} style={{
                alignSelf: "stretch"
            }} />
          </div>
      ...
      <BottomActionBar actionLabel="Book now" bookingDetailsLabel="Booking details" fromLabel="Starting from" originalPrice="$1,500" paymentMethod="Apple Pay" price="$1,215" type="starting-price" />
    </main>
  )
}
