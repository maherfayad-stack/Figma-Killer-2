          ...
          <div className={styles.instruction}>
            ...
            <div className={styles.channelRow}>
              <svg className={styles.channelIcon} width="24" height="24" viewBox="0 0 24 24" fill="none" aria-hidden="true">
                <path d="M4 6.5C4 5.11929 5.11929 4 6.5 4H15.5C16.8807 4 18 5.11929 18 6.5V13.5C18 14.8807 16.8807 16 15.5 16H10L6 20V16H6.5C5.11929 16 4 14.8807 4 13.5V6.5Z" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round" fill="none" />
              </svg>
