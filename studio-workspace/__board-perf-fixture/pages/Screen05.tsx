  ...
  return (
    <main className="screen">
      <header className="screen__bar">
        <span className="screen__title">Support</span>
        <span className="screen__badge">Frame 5 of 12</span>
      </header>

      <section className="panel">
        <h2 className="panel__heading">Support summary</h2>
      ...
      <ul className="tiles">
        <li className="tile">
          ...
          <span className="tile__value">45</span>
        </li>
        <li className="tile">
          <span className="tile__label">Bravo</span>
          <span className="tile__value">58</span>
        </li>
        <li className="tile">
          <span className="tile__label">Charlie</span>
          <span className="tile__value">71</span>
        </li>
        <li className="tile">
          <span className="tile__label">Delta</span>
          <span className="tile__value">84</span>
        </li>
        <li className="tile">
          <span className="tile__label">Echo</span>
          <span className="tile__value">97</span>
        </li>
        <li className="tile">
          <span className="tile__label">Foxtrot</span>
          <span className="tile__value">20</span>
        </li>
      </ul>
