  ...
  return (
    <main className="screen">
      <header className="screen__bar">
        <span className="screen__title">Overview</span>
        <span className="screen__badge">Frame 1 of 12</span>
      </header>

      <section className="panel">
        <h2 className="panel__heading">Overview summary</h2>
      ...
      <ul className="tiles">
        ...
        <li className="tile">
          ...
          <span className="tile__value">82</span>
        </li>
      </ul>
