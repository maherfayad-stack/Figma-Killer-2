  ...
  return (
    <main className="screen">
      <header className="screen__bar">
        <span className="screen__title">Notifications</span>
        <span className="screen__badge">Frame 10 of 12</span>
      </header>

      <section className="panel">
        <h2 className="panel__heading">Notifications summary</h2>
      ...
      <ul className="tiles">
        <li className="tile">
          ...
          <span className="tile__value">80</span>
        </li>
        <li className="tile">
          <span className="tile__label">Bravo</span>
          <span className="tile__value">93</span>
        </li>
        <li className="tile">
          <span className="tile__label">Charlie</span>
          <span className="tile__value">16</span>
        </li>
        <li className="tile">
          <span className="tile__label">Delta</span>
          <span className="tile__value">29</span>
        </li>
        <li className="tile">
          <span className="tile__label">Echo</span>
          <span className="tile__value">42</span>
        </li>
        <li className="tile">
          <span className="tile__label">Foxtrot</span>
          <span className="tile__value">55</span>
        </li>
      </ul>
