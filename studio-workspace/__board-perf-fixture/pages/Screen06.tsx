  ...
  return (
    <main className="screen">
      <header className="screen__bar">
        <span className="screen__title">Roaming</span>
        <span className="screen__badge">Frame 6 of 12</span>
      </header>

      <section className="panel">
        <h2 className="panel__heading">Roaming summary</h2>
      ...
      <ul className="tiles">
        <li className="tile">
          ...
          <span className="tile__value">52</span>
        </li>
        <li className="tile">
          <span className="tile__label">Bravo</span>
          <span className="tile__value">65</span>
        </li>
        <li className="tile">
          <span className="tile__label">Charlie</span>
          <span className="tile__value">78</span>
        </li>
        <li className="tile">
          <span className="tile__label">Delta</span>
          <span className="tile__value">91</span>
        </li>
        <li className="tile">
          <span className="tile__label">Echo</span>
          <span className="tile__value">14</span>
        </li>
        <li className="tile">
          <span className="tile__label">Foxtrot</span>
          <span className="tile__value">27</span>
        </li>
      </ul>
