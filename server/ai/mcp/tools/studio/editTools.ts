...
const ApplyEditsInputSchema = Type.Object(
  {
    ...
    edits: Type.Array(StudioEditSchema, {
      description: 'A batch of typed source edits — same shape POST /admin/api/studio/save accepts (kind: prop|text|style|literal|tag|asset|detach|swap|insert|delete|move|css).',
      minItems: 1,
    }),
  },
