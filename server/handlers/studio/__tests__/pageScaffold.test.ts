...
import { detectPageFileExtension, scaffoldedPageRootNodeId } from '../pageScaffold'
import { autoPlaceBoardFrame, syncBoardFramesFromDisk } from '../boardFrames'
...
describe('scaffoldedPageRootNodeId', () => {
  it('returns the real root node id by parsing the file — never a constructed string', () => {
    ...
    const starter = starterPage('Home', 'screen', { kit: 'plain', designSystemImport: '../design-system' })
