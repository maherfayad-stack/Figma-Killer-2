...
+ P5-B — image files dropped from the OS; `insertJsxSubtreeIntoPage`, P5-A — an
SVG pasted from the OS clipboard, one `insert` whose `children` carry the whole
converted subtree) take their page id as an argument
