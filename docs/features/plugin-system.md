# Plugin System
> **Purpose:** the inherited plugin system: package shape, sandbox, SDK, permissions · **Read when:** touching plugins or the QuickJS sandbox · **Trust:** current-cms · **Owner:** server-engineer · **Verified:** not yet
