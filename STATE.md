...
- **Agent:** canvas-engineer · **Branch:** `fix/dropped-images-show-in-design-frames` off `fea4f125` · **PR:** draft, base `feat/canvas-excellence` (attack surface for the security review in its body) · **Updated:** 2026-09-25
