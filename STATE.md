...
- **Stage:** gates, then a draft PR against `feat/canvas-excellence`; a separate security review follows. The threat | fix | test table is the PR body.
...
- **Next:** gates, then the PR, then the security review.
