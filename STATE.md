...
### store-20 — P3-D: structural refusals become writes (ERR-7, ERR-8, ERR-16, WB-14, WB-20, WB-21, WB-22; WB-15/OD-8 → P3-D2)
...
- **Stage:** verifying: gates done (below); owner dogfood pending. Was filed as `store-19` before P3-E took that ID on the trunk.
- **Done:**
